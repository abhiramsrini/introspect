# SVT Test
# SVT version 25.2.0
# Test saved 2025-07-08_1732
# Form factor: SV5C_4L8G_MIPI_DPHY_ANALYZER
# PY3
# Checksum: 926905f5ffab5f86e694d0a551b2824b
...
for lane in [1,2,3,4] :
    ...
    averageVoltageForLaneHigh[lane] = results.getAnalysis(lane)['digitizedLevels'][1]#computeHighVoltage(voltages)
    averageVoltageForLaneLow[lane] = results.getAnalysis(lane)['digitizedLevels'][0]#computeLowVoltage(voltages)
...
for trial in range(numberOfMaxTrials):
    ...
    averageVoltageForLaneLow[5] = clk_result.getAnalysis(1)['digitizedLevels'][0]#computeLowVoltage(voltages)
    averageVoltageForLaneHigh[5] = clk_result.getAnalysis(1)['digitizedLevels'][1]#computeHighVoltage(voltages)
...
for trial in range(numberOfMaxTrials):
    ...
    averageVoltageForLaneLow[6] = clk_result.getAnalysis(1)['digitizedLevels'][0]#computeLowVoltage(voltages)
    averageVoltageForLaneHigh[6] = clk_result.getAnalysis(1)['digitizedLevels'][1]#computeHighVoltage(voltages)
