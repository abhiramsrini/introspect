# SVT Test
# SVT version 23.1.b6
# Test saved 2022-11-25_1535
# Form factor: SV5C_4L8G_MIPI_CPHY_ANALYZER
# PY3
# Checksum: f5227c810d4934a1ab6f3f9ba989905c
...
SetupFunction.code = r'''#enable alignment cal mode.
...
for i in range(length):
    ...
    if abs(delta) > 30:
        failFlag = 1
        warningMsg("Found a failing condition when computing the edge locations difference: index1=%d, index2=%d, difference=%f ..." % (i, (i//3)*3, delta))
...
eyeScan1.endPhase = None
eyeScan1.endVoltage = 450.0
...
eyeScan1.startPhase = None
eyeScan1.startVoltage = -450.0
