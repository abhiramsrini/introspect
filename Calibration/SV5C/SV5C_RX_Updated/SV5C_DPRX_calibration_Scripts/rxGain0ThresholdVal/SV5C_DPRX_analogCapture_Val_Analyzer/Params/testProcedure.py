...
# Test saved 2025-08-04_1017
# Form factor: SV5C_4L8G_MIPI_DPHY_ANALYZER
# PY3
# Checksum: ce0b0a2777b8e8d23d377011eb62a7c5
...
for lane in [1,2,3,4] :
    ...
    src = HwTarget(lane)
    digitized_voltages = result.analysisByChannel[src]['digitizedLevels']

    averageVoltageForLaneHigh[lane] = digitized_voltages[1]
    averageVoltageForLaneLow[lane] = digitized_voltages[0]
...
for trial in range(numberOfMaxTrials):
    ...
    averageVoltageForLaneLow[5] = digitized_voltages[0]
    averageVoltageForLaneHigh[5] = digitized_voltages[1]
...
for trial in range(numberOfMaxTrials):
    ...
    averageVoltageForLaneLow[6] = digitized_voltages[0]
    averageVoltageForLaneHigh[6] = digitized_voltages[1]
