# SVT Test
# SVT version 23.1.b6
# Test saved 2022-11-25_1712
# Form factor: SV5C_4L8G_MIPI_DPHY_GENERATOR
# PY3
# Checksum: a7e464b8feb4d297d74277214d3b7ff1
...
commandPattern1 = _create('commandPattern1', 'SvtMipiDphyCommandPattern')
...
commandPattern1.autoAdjustHsOnlyPatterns = True
commandPattern1.codeSource = 'inAppEditor'
commandPattern1.commandsFile = r""
commandPattern1.customCode = r'''#Please refer to the help menu of this component for how to use this section
#The default mode is LP
#clockPrbsHsOnly(5, seed=0x13)

#setHs()
#prbs(5, hsLpDelim='none')

calibrationPrbsHsOnly(9, seed=0xFF)
'''
...
mipiGenerator1.pattern = commandPattern1
...
#disable clk offset so that clock lane is not offset by 0.5UI
#need for calibration
print('Disable clk offset')
iesp.writeSubPartRegister(0x0934, 0x00, 0x01)

#this command pattern allows prbs9 to be played on all lanes including the clock lanes
#need for calibration
mipiGenerator1.pattern = commandPattern1
...
print('Enable again clk offset')
# enable again clk offset
