# SVT Test
# SVT version 25.3.0
# Test saved 2025-10-27_1324
# Form factor: SV3C_4L6G_MIPI_DPHY_GENERATOR
# PY3
# Checksum: 496574586f53c8af265ff25777e41a59
...
autoscaleScope.args = ''
autoscaleScope.code = r'''import time
...
calOptions.addField('serialNumber', descrip='''Serial number for device under test''', attrType=str, iespInstanceName='SV3C_4L6G_MIPI_DPHY_GENERATOR', defaultVal='1234', displayOrder=(0, 1.0))
calOptions.addField('scopeIPAddress', descrip='''Visa string specifying location of the calibration scope. Only Keysight scopes are supported''', attrType=str, iespInstanceName='SV3C_4L6G_MIPI_DPHY_GENERATOR', defaultVal='TCPIP0::10.20.20.200::inst0::INSTR', displayOrder=(0, 2.0))
calOptions.addField('scopeMeasurementDelay', descrip='''Amount of average accumulation time in milliseconds''', attrType=float, iespInstanceName='SV3C_4L6G_MIPI_DPHY_GENERATOR', defaultVal=1000.0, displayOrder=(0, 3.0))
calOptions.addField('scopeAutoScaleDelay', descrip='''Amount of time after the scope auto scale funtion.''', attrType=float, iespInstanceName='SV3C_4L6G_MIPI_DPHY_GENERATOR', defaultVal=2000.0, displayOrder=(0, 4.0))
calOptions.addField('numAverages', descrip='''Number of times the measurement is queried from the scope.''', attrType=int, iespInstanceName='SV3C_4L6G_MIPI_DPHY_GENERATOR', defaultVal=100, displayOrder=(0, 5.0))
calOptions.addField('calLanes', descrip='''Range of lanes to measure''', attrType=list, iespInstanceName='SV3C_4L6G_MIPI_DPHY_GENERATOR', attrSubType=int, defaultVal=[1, 2, 3, 4, 5], displayOrder=(0, 6.0))
calOptions.addField('calRates', descrip='''Rates at which we will collect alignment data.''', attrType=list, iespInstanceName='SV3C_4L6G_MIPI_DPHY_GENERATOR', attrSubType=float, defaultVal=[80.0, 93.75, 109.375, 125.0, 140.625, 156.25, 171.875, 187.5, 6500.0], displayOrder=(0, 7.0))
calOptions.addField('scopeSetupFile', descrip='''''', attrType=str, iespInstanceName='SV3C_4L6G_MIPI_DPHY_GENERATOR', defaultVal='Placeholder', displayOrder=(0, 8.0))
calOptions.addField('deltaTimeThreshold', descrip='''Threshold for alignment convergence''', attrType=float, iespInstanceName='SV3C_4L6G_MIPI_DPHY_GENERATOR', defaultVal=3e-12, displayOrder=(0, 9.0))
calOptions.addField('scopeConnectionTimeout', descrip='''Timeout used by PyVisa''', attrType=float, iespInstanceName='SV3C_4L6G_MIPI_DPHY_GENERATOR', defaultVal=10000.0, displayOrder=(0, 10.0))
...
osci.writestring("VBS 'app.Acquisition.C1.VerScale = 20e-3'", 1)
osci.writestring("VBS 'app.Acquisition.C1.VerOffset = -100.02e-3'", 1)
osci.writestring("VBS 'app.Acquisition.C2.VerScale = 20e-3'", 1)
osci.writestring("VBS 'app.Acquisition.C2.VerOffset = -100.02e-3'", 1)
osci.writestring("VBS 'app.Acquisition.C3.VerScale = 20e-3'", 1)
osci.writestring("VBS 'app.Acquisition.C3.VerOffset = -100.02e-3'", 1)
...
osci.WriteString("VBS 'app.Acquisition.Horizontal.HorScale = 200e-12'", 1)
...
osci.writestring("VBS 'app.Acquisition.Trigger.C1Level = 100e-3'", 1)
