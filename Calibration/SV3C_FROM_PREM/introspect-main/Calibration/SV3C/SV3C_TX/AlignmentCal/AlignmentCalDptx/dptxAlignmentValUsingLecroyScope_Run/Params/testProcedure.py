...
# PY3
# Checksum: 3aa8feee5277cd73c831025d6f711855
...
testAsComponent1 = _create('testAsComponent1', 'SvtTestAsComponent')
...
validationOptions.addField('serialNumber', descrip='''Serial number for device under test''', attrType=str, iespInstanceName='SV3C_4L6G_MIPI_DPHY_GENERATOR', defaultVal='1234', displayOrder=(0, 1))
validationOptions.addField('scopeIPAddress', descrip='''Visa string specifying location of the calibration scope. Only Keysight scopes are supported''', attrType=str, iespInstanceName='SV3C_4L6G_MIPI_DPHY_GENERATOR', defaultVal='TCPIP0::10.20.20.200::inst0::INSTR', displayOrder=(0, 2))
validationOptions.addField('scopeMeasurementDelay', descrip='''Amount of average accumulation time in milliseconds''', attrType=float, iespInstanceName='SV3C_4L6G_MIPI_DPHY_GENERATOR', defaultVal=1000.0, displayOrder=(0, 3))
validationOptions.addField('scopeAutoScaleDelay', descrip='''Amount of time after the scope auto scale funtion.''', attrType=float, iespInstanceName='SV3C_4L6G_MIPI_DPHY_GENERATOR', defaultVal=2000.0, displayOrder=(0, 4))
validationOptions.addField('numAverages', descrip='''Number of times the measurement is queried from the scope.''', attrType=int, iespInstanceName='SV3C_4L6G_MIPI_DPHY_GENERATOR', defaultVal=100, displayOrder=(0, 5))
validationOptions.addField('calLanes', descrip='''Range of lanes to measure''', attrType=list, iespInstanceName='SV3C_4L6G_MIPI_DPHY_GENERATOR', attrSubType=int, defaultVal=[1, 2, 3, 4], displayOrder=(0, 6))
validationOptions.addField('calRates', descrip='''Rates at which we will collect alignment data.''', attrType=list, iespInstanceName='SV3C_4L6G_MIPI_DPHY_GENERATOR', attrSubType=float, defaultVal=[80.0, 125.0, 187.5, 6500.0], displayOrder=(0, 7))
validationOptions.addField('deltaTimeThreshold', descrip='''Threshold for alignment convergence''', attrType=float, iespInstanceName='SV3C_4L6G_MIPI_DPHY_GENERATOR', defaultVal=1e-11, displayOrder=(0, 8))
validationOptions.addField('scopeConnectionTimeout', descrip='''Scope connection timeout.''', attrType=float, iespInstanceName='SV3C_4L6G_MIPI_DPHY_GENERATOR', defaultVal=10000.0, displayOrder=(0, 9))
validationOptions.addField('minVersion', descrip='''Minimum Introspect ESP software version that is supported by this script.''', attrType=str, iespInstanceName='SV3C_4L6G_MIPI_DPHY_GENERATOR', defaultVal='3.5.55', displayOrder=(0, 10))
