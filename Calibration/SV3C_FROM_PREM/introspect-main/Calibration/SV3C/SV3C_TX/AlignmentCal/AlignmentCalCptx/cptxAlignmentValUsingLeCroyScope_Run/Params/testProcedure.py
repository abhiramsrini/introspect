# SVT Test
# SVT version 25.3.0
# Test saved 2025-10-28_1232
# Form factor: SV3C_4L3G_MIPI_CPHY_GENERATOR
# PY3
# Checksum: fec428b895c4e53d0e7600ad1d09de63
...
osci.writestring("VBS 'app.Acquisition.C4.VerScale = 50e-3'", 1)
osci.writestring("VBS 'app.Acquisition.C4.VerOffset = -97e-3'", 1)
