# SVT Test
# SVT version 25.3.0
# Test saved 2025-10-17_1522
# Form factor: SV3C_4L3G_MIPI_CPHY_GENERATOR
# PY3
# Checksum: 8bf1558a0fb8d3b622bce5169a69c9c4
...
osci.WriteString("VBS 'app.Measure.StatisticsMode = \"MeanOnly\"'", 1)
...
osci.WriteString("VBS 'app.Acquisition.Trigger.Edge.Level = 100e-03'", 1)
