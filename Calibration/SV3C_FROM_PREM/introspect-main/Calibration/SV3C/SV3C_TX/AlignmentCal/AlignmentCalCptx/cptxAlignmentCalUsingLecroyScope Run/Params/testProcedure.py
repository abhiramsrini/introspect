# SVT Test
# SVT version 25.3.0
# Test saved 2025-10-24_1744
# Form factor: SV3C_4L3G_MIPI_CPHY_GENERATOR
# PY3
# Checksum: b420f6f48743814e86a8a5c979e7d4fe
...
# Set Vertical scale for Channel 4 to proper value
...
osci.writestring("VBS 'app.Acquisition.C4.VerScale = 20e-3'", 1)
osci.writestring("VBS 'app.Acquisition.C4.VerOffset = -100.02e-3'", 1)
