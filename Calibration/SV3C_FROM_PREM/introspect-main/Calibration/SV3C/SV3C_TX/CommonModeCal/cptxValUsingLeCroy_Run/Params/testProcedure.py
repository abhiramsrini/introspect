# SVT Test
# SVT version 25.3.0
# Test saved 2025-10-28_1324
# Form factor: SV3C_4L3G_MIPI_CPHY_GENERATOR
# PY3
# Checksum: ab5d2cc34b0d1dabdd03988fbe6295d3
...
for channel in [1,2,3] :
    ...
    osci.WriteString("*OPC?", 1)
    try:
        varAverage = float(varAverage.strip()) *1000/0.476
        #varAverage = float(varAverage.strip()) * 1000 * (50 + impedance) / 50
        #varAverage = float(varAverage.strip()) * 1000  #convert to mV
        print(varAverage)
